...
const welcomeChannelComment = "VALORANT특별 과정에 오신것을 환영합니다.";
...
client.on('message', (message) => {
  ...
  if(message.content == '상태확인') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .addBlankField()
      .addField('상태', '좋음')
      .addField('연결속도', '느림', true)
      .addField('시간', '기능 없음', true)
      .addField('날씨', '기능 없음', true)
      .addField('사용하는 서버', '링링팜')
      .addBlankField()
      .setTimestamp()
    ...
    let commandStr = '상태 확인';
    let embed = new Discord.RichEmbed()
      .setAuthor('Help of 인성봇', helpImg)
      .setColor('#186de6')
      .setFooter(`인성 봇`)
      .setTimestamp()
    ...
    embed.addField('Commands: 상태확인 ', commandStr);
